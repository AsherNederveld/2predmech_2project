#ifndef REPLACEMENT_mockingjay_orig_H
#define REPLACEMENT_mockingjay_orig_H
...
class mockingjay_orig : public champsim::modules::replacement
{
  long NUM_SET;
  long NUM_WAY;
...
public:
  CACHE* cache;
  explicit mockingjay_orig(CACHE* cache);
